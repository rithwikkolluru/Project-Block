...
import { Input, Button, Tag, Drawer, Spin } from 'antd';
...
export const NetworkMapPage = () => {
  ...
  const handleSearch = async () => {
    ...
    // const response = await fetch(`/api/networkmap?wallet=${address}`);
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <Button 
                ...
                block 
                size="large"
                className="mt-4 shadow-[0_0_15px_rgba(239,68,68,0.4)] border-none"
              >
                Report as Scam
              </Button>
            </div>
