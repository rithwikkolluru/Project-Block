...
export const RegistryPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 relative z-10 w-full mb-20">
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl mb-12 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <Select 
            size="large"
            defaultValue="all" 
            className="w-full md:w-48 bg-black/40 text-white border-white/20"
          ...
          <DatePicker 
            size="large" 
            className="bg-black/40 text-white border-white/20 hover:border-gravityAccent w-full md:w-auto" 
      ...
      <div className="bg-black/40 border border-gravityAccent/30 rounded-2xl p-6 md:p-10 backdrop-blur-xl shadow-[0_0_40px_rgba(99,102,241,0.1)]">
        ...
        >
          ...
          >
            <Input size="large" className="bg-white/5 border-white/20 text-white placeholder:text-white/30" prefix={<Link size={16} className="text-white/40 mr-2" />} placeholder="https://..." />
          </Form.Item>

          <Form.Item>
            <Button type="primary" htmlType="submit" size="large" className="bg-gravityAccent border-none hover:bg-gravityAccent/80 font-bold px-8">
              Submit Report
            </Button>
          </Form.Item>
        </Form>
